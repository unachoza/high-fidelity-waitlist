...
const AHEAD = [
	...
	{
		title: "Get dressed in minutes.",
		body: "A closet full of clean clothes, and you still lose 15, 20, or even 30 minutes every morning. Once the app knows what is clean, at home, and not lent out, it can hand you one outfit for the day — already available, already appropriate.",
	},
] as const;
